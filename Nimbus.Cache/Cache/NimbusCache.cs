...
namespace Nimbus.Cache
{
    ...
    public class NimbusCache<K, V> : INimbusCache<K, V>
    {
        /// <summary>
        ...
        private readonly string _cachePath = Path.GetFullPath(@"..\..\_nimbus\nimbuscache");
        private readonly string _cacheDirectoryPath = Path.GetFullPath(@"..\..\_nimbus");
        private static ConcurrentDictionary<K, CacheData<V>> _cacheDic;
        private static ConcurrentDictionary<K, Timer> _timerDic;
        private static NimbusCache<K, V> _cache;
        private static Timer _cleaner;
        private int _dormantCacheCount;
        private static System.Threading.Mutex mutex = new System.Threading.Mutex();
        /// <summary>
        /// Initializes NimbusCache, creates a directory '_nimbus' in root if not present.
        /// </summary>
        /// <param name="size">Count of total entries in Active(in-memory) NimbusCache</param>
        ...
        public static INimbusCache<K, V> Initialize(int size = 1000, int activeCacheExpire = 300000, int dormantCacheExpire = 500000, int cleanerSnoozeTime = 120000)
        {
            if (_cache == null)
            {
                _cache = new NimbusCache<K, V>(size, activeCacheExpire, dormantCacheExpire, cleanerSnoozeTime);
            }
            _cache.LoadCache();
            return _cache;
        }
        ...
        /// <summary>
        /// Disposes and writes the entries in Active NimbusCache to Dormant NimbusCache.
        /// </summary>
        public void Dispose()
        {
            var dic = ReadBinary();
        ...
        private NimbusCache(int size = 1000, int activeCacheExpire = 300000, int dormantCacheExpire = 500000, int cleanerSnoozeTime = 120000) : base()
        {
        ...
        /// <summary>
        /// Tries to add value from Dormant NimbusCache to Active NimbusCache using LFU.
        /// </summary>
        ...
        // <summary>
        /// Tries to replace value having key to Active NimbusCache or Dormant NimbusCache.
        /// </summary>
        /// <returns>Returns frequency of added/removed entry</returns>
